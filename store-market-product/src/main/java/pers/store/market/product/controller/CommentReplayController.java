...
import pers.store.market.product.service.CommentReplayService;
...
public class CommentReplayController {
    ...
    @ApiImplicitParam(paramType = "body", name = "commentReplay", dataType = "CommentReplayEntity", required = true, value = "实体类")
