...
import pers.store.market.coupon.service.HomeSubjectSpuService;
...
@Api(tags = "专题商品接口")
@RestController
@RequestMapping("ware/homeSubjectSpu")
public class HomeSubjectSpuController {
    ...
    @ApiImplicitParam(paramType = "body", name = "homeSubjectSpu", dataType = "HomeSubjectSpuEntity", required = true, value = "实体类")
