...
import pers.store.market.coupon.entity.SpuBoundsEntity;
import pers.store.market.coupon.service.SpuBoundsService;
 ...
 */
@Api(tags = "商品spu积分设置接口")
@RestController
@RequestMapping("ware/spuBounds")
