...
import pers.store.market.coupon.entity.CouponSpuRelationEntity;
import pers.store.market.coupon.service.CouponSpuRelationService;
...
@Api(tags = "优惠券产品关联接口")
@RestController
@RequestMapping("ware/couponSpuRelation")
