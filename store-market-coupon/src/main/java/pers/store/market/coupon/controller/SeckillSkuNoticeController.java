...
import pers.store.market.coupon.entity.SeckillSkuNoticeEntity;
import pers.store.market.coupon.service.SeckillSkuNoticeService;
...
@Api(tags = "秒杀商品通知订阅接口")
@RestController
@RequestMapping("coupon/seckillNotice")
public class SeckillSkuNoticeController {
    ...
    @ApiImplicitParam(paramType = "body", name = "seckillSkuNotice", dataType = "SeckillSkuNoticeEntity", required = true, value = "实体类")
