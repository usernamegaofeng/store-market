...
import pers.store.market.member.service.MemberStatisticsInfoService;
...
public class MemberStatisticsInfoController {
    ...
    @ApiImplicitParam(paramType = "body", name = "memberStatisticsInfo", dataType = "MemberStatisticsInfoEntity", required = true, value = "实体类")
