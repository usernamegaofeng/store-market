...
import pers.store.market.member.dao.MemberReceiveAddressDao;
...
public class MemberReceiveAddressServiceImpl extends ServiceImpl<MemberReceiveAddressDao, MemberReceiveAddressEntity> implements MemberReceiveAddressService {
    ...
    public List<MemberReceiveAddressEntity> getAddress(Long id) {
       return this.getBaseMapper().selectList(new QueryWrapper<MemberReceiveAddressEntity>().eq("member_id",id));
    }
